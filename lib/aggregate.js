 ...
 * #### Example:
 *
 *      aggregate.documents([ { x: 10 }, { x: 2 }, { x: 5 } ]);
 *
 * @see $documents https://docs.mongodb.com/manual/reference/operator/aggregation/documents/
 * @method documents
 * @memberOf Aggregate
 * @instance
 * @param {ArrayExpression} expression $documents operator content
 * @return {Aggregate}
 * @api public
 */

Aggregate.prototype.documents = function(expression) {
  return this.append({ $documents: expression });
};
